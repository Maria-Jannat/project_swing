 ...
 * @author user
 */
public class PositionView extends javax.swing.JFrame {
    ...
    CommonService commonService = new PositionServiceImplementation();
    ...
    private void initComponents() {
        ...
        cmbPosition.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Please Select:", "Advisor", "Administrative Officer", "Analytics Officer", "Business Development Officer", "Chief Administrative Officer (CAO)", "Chief Analytics Officer (CAO)", "Chief Business Development Officer (CBDO)", "Chief Compliance Officer (CCO) ", "Chief Data Officer (CDO)", "Chief Executive Officer (CEO)", "Chief Financial Officer (CFO)", "Chief Human Resources Officer (CHRO)", "Chief Investment Officer (CIO)", "Chief Legal Officer (CLO) ", "Chief Marketing Officer (CMO)", "Chief Operating Officer (COO) ", "Chief Revenue Officer (CRO)", "Chief Web Officer (CWO)", "Co-ordinator", "Compliance Officer ", "Data Officer", "Executive Officer", "Financial Officer", "General Manager", "Human Resources Officer", "Investment Officer ", "Legal Officer ", "Marketing Officer", "Operating Officer ", "Revenue Officer ", "Systems Engineering Manager", "Web Officer " }));
        cmbPosition.setPreferredSize(new java.awt.Dimension(250, 25));

        btnAddPosition.setBackground(new java.awt.Color(102, 0, 51));
        btnAddPosition.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnAddPosition.setForeground(new java.awt.Color(255, 255, 255));
        btnAddPosition.setText("Add Position");
        btnAddPosition.setPreferredSize(new java.awt.Dimension(300, 35));
        ...
        txtPositionId.setPreferredSize(new java.awt.Dimension(250, 25));
                    ...
                    .addGroup(kGradientPanel3Layout.createSequentialGroup()
                        .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(kGradientPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(30, 30, 30)
                                .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnAddPosition, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(txtPositionId, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            ...
            .addGroup(kGradientPanel3Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(kGradientPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel11)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnAddPosition, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        tblDisplay.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Position Id", "Position Name", "Remark"
            }
        ));
    ...
    public void displayDataIntoTable() {
        ...
        List<Position> list = commonService.getList();
        for (int i = 0; i < list.size(); i++) {
            row[0] = list.get(i).getPositionId();
            row[1] = list.get(i).getPositionName();
    ...
    private void btnAddPositionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPositionActionPerformed
        ...
        String positionName = cmbPosition.getSelectedItem().toString();
        String remark = txtAreaDescription.getText().trim();

        //////////// validation started/////////////
        if (positionName.equalsIgnoreCase("Please Select:")) {
            JOptionPane.showMessageDialog(rootPane, "Select the Position");
            ...
            Position position = new Position(cmbPosition.getSelectedItem().toString(), txtAreaDescription.getText().trim());
            commonService.save(position);
            displayDataIntoTable();
            clear();
...
//        Utils.readDataFromFile("Project", model);
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("select * from position_table");
            ResultSet rs = ps.executeQuery();
            DefaultTableModel model = (DefaultTableModel) tblDisplay.getModel();
            model.setRowCount(0);
            while (rs.next()) {
                Object o[] = {rs.getInt("Position_Id"), rs.getString("Position_Name"), rs.getString("Remark")
                };
                model.addRow(o);
            }
        } catch (Exception e) {
    ...
    private void tblDisplayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDisplayMouseClicked
        ...
        txtPositionId.setText(String.valueOf(model.getValueAt(i, 0)));
        cmbPosition.setSelectedItem(model.getValueAt(i, 1));
    ...
    private void btnEditDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditDataActionPerformed
        Position position = new Position(Integer.parseInt(txtPositionId.getText().trim()), cmbPosition.getSelectedItem().toString(), txtAreaDescription.getText().trim());
        commonService.update(position);
        displayDataIntoTable();
        clear();
    ...
    private void btnDeleteDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteDataActionPerformed
        ...
        if (i == 0) {
            commonService.delete(Integer.parseInt(txtPositionId.getText().trim()));
            displayDataIntoTable();
            clear();
